...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th4 24, 2025 lúc 01:34 PM
...
--
ALTER TABLE `hoadon`
  ADD CONSTRAINT `fk_mahang` FOREIGN KEY (`mahang`) REFERENCES `hanghoa` (`mahang`);
COMMIT;
